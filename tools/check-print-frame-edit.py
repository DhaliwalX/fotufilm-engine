...
with tempfile.TemporaryDirectory(prefix='fotufilm-print-frame-edit-') as directory:
    ...
    files = ['macos/Tests/PrintFrameEdit.swift', 'shared/FotufilmApp/EditSession.swift', 'shared/FotufilmApp/EditState.swift',
