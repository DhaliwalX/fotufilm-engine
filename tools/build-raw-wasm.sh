...
em++ -O3 -fexceptions -I"$SOURCE" web/engine/raw_wasm.cpp "$SOURCE/lib/.libs/libraw.a" \
  ...
  -sEXPORTED_FUNCTIONS=_raw_open,_raw_unpack,_raw_process,_raw_width,_raw_height,_raw_colors,_raw_make,_raw_model,_raw_lens_model,_raw_lens_make,_raw_focal_length,_raw_aperture,_raw_camera_channels,_raw_camera_wb,_raw_camera_to_xyz,_raw_scene_scale,_raw_pixels,_raw_close,_raw_error,_malloc,_free \
