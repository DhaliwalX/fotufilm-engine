...
class GpuMeasurePipeline : public GpuSchedule {
public:
    enum class Quantity { Tone, Flare };

    GpuMeasurePipeline(Quantity quantity, bool approximate,
...
class GpuDecodePipeline : public GpuSchedule {
public:
    GpuDecodePipeline(bool approximate, const std::string &suffix,
                        GpuConfiguration configuration = default_gpu_configuration())
...
class GpuFramePipeline : public GpuSchedule, FrameParams {
public:
    GpuFramePipeline(int32_t feature_mask, const std::string &suffix,
                       bool windowed = false,
                       GpuConfiguration configuration = default_gpu_configuration())
...
class GpuHalationFieldsPipeline : public GpuSchedule {
public:
    explicit GpuHalationFieldsPipeline(const std::string &suffix,
                                         GpuConfiguration configuration = default_gpu_configuration())
