...
#else
@_silgen_name("fotufilm_halide_metal_available")
private func fotufilm_halide_metal_available() -> Int32
@_silgen_name("fotufilm_halide_metal_variant_exists")
private func fotufilm_halide_metal_variant_exists(_ featureMask: Int32) -> Int32
@_silgen_name("fotufilm_halide_metal_prepare")
private func fotufilm_halide_metal_prepare(
    _ featureMask: Int32,
    _ exposure: UnsafePointer<Float>?, _ film: UnsafePointer<Float>?,
    _ paper: UnsafePointer<Float>?, _ dimension: Int32, _ cacheID: UInt64
) -> Int32
@_silgen_name("fotufilm_halide_metal_process_srgb8")
private func fotufilm_halide_metal_process_srgb8(
    _ input: UnsafePointer<UInt8>?, _ output: UnsafeMutablePointer<UInt8>?,
    _ width: Int32, _ height: Int32, _ configuration: UnsafePointer<Float>?,
    _ exposure: UnsafePointer<Float>?, _ film: UnsafePointer<Float>?,
    _ paper: UnsafePointer<Float>?, _ dimension: Int32, _ cacheID: UInt64,
    _ featureMask: Int32, _ seed: UInt32
) -> Int32
@_silgen_name("fotufilm_halide_metal_process_buffers")
private func fotufilm_halide_metal_process_buffers(
    _ input: UInt64, _ output: UInt64, _ width: Int32, _ height: Int32,
...
private func fotufilm_halide_metal_process_buffers_float(
    _ input: UInt64, _ output: UInt64, _ width: Int32, _ height: Int32,
    _ originX: Int32, _ originY: Int32,
    _ configuration: UnsafePointer<Float>?, _ exposure: UnsafePointer<Float>?,
    _ film: UnsafePointer<Float>?, _ paper: UnsafePointer<Float>?,
...
/// The two whole-frame measurements, over a band handed across either as a device buffer or as
/// host rows — one of the two, never both.
@_silgen_name("fotufilm_halide_metal_measure_tone_rows")
private func fotufilm_halide_metal_measure_tone_rows(
...
private func fotufilm_halide_metal_measure_flare_rows(
    _ input: UInt64, _ inputRows: UnsafePointer<Float>?,
...
/// The host-to-engine decode, over caller-owned buffers on either side — a device handle or host
/// rows, chosen independently. Writes two floats per row: the host's own peak before any repair,
/// and whether the row needed repairing.
@_silgen_name("fotufilm_halide_metal_decode_rows")
private func fotufilm_halide_metal_decode_rows(
    _ input: UInt64, _ inputRows: UnsafePointer<Float>?,
    _ output: UInt64, _ outputRows: UnsafeMutablePointer<Float>?,
    _ report: UnsafeMutablePointer<Float>?,
    _ width: Int32, _ rows: Int32, _ parameters: UnsafePointer<Float>?
) -> Int32
@_silgen_name("fotufilm_halide_metal_decode_rows_realtime")
private func fotufilm_halide_metal_decode_rows_realtime(
    _ input: UInt64, _ inputRows: UnsafePointer<Float>?,
    _ output: UInt64, _ outputRows: UnsafeMutablePointer<Float>?,
    _ report: UnsafeMutablePointer<Float>?,
    _ width: Int32, _ rows: Int32, _ parameters: UnsafePointer<Float>?
...
@_silgen_name("fotufilm_halide_metal_process_buffers_head")
private func fotufilm_halide_metal_process_buffers_head(
    _ input: UInt64, _ density: UInt64, _ width: Int32, _ height: Int32,
    _ originX: Int32, _ originY: Int32,
    _ configuration: UnsafePointer<Float>?, _ exposure: UnsafePointer<Float>?,
    _ film: UnsafePointer<Float>?, _ paper: UnsafePointer<Float>?,
    _ dimension: Int32, _ cacheID: UInt64, _ featureMask: Int32, _ seed: UInt32
) -> Int32
@_silgen_name("fotufilm_halide_metal_process_buffers_tail")
private func fotufilm_halide_metal_process_buffers_tail(
    _ density: UInt64, _ output: UInt64, _ width: Int32, _ height: Int32,
    _ densityWidth: Int32, _ densityHeight: Int32,
    _ originX: Int32, _ originY: Int32,
    _ configuration: UnsafePointer<Float>?, _ exposure: UnsafePointer<Float>?,
    _ film: UnsafePointer<Float>?, _ paper: UnsafePointer<Float>?,
    _ dimension: Int32, _ cacheID: UInt64, _ featureMask: Int32, _ seed: UInt32
...
private func fotufilm_halide_metal_process_linear_float(
...
@_silgen_name("fotufilm_halide_metal_process_linear_float_rows")
private func fotufilm_halide_metal_process_linear_float_rows(
    _ input: UnsafePointer<Float>?, _ output: UnsafeMutablePointer<Float>?,
    _ width: Int32, _ height: Int32, _ outY: Int32, _ outRows: Int32,
    _ originX: Int32, _ originY: Int32,
    _ configuration: UnsafePointer<Float>?, _ exposure: UnsafePointer<Float>?,
    _ film: UnsafePointer<Float>?, _ paper: UnsafePointer<Float>?,
    _ dimension: Int32, _ cacheID: UInt64, _ featureMask: Int32, _ seed: UInt32
) -> Int32
@_silgen_name("fotufilm_halide_metal_still_fast_bits")
private func fotufilm_halide_metal_still_fast_bits() -> Int32
@_silgen_name("fotufilm_halide_metal_process_light_rows")
private func fotufilm_halide_metal_process_light_rows(
    _ input: UnsafePointer<Float>?, _ lightOut: UnsafeMutablePointer<Float>?,
    _ width: Int32, _ height: Int32, _ outY: Int32, _ outRows: Int32,
    _ originX: Int32, _ originY: Int32,
    _ configuration: UnsafePointer<Float>?, _ exposure: UnsafePointer<Float>?,
    _ film: UnsafePointer<Float>?, _ paper: UnsafePointer<Float>?,
...
@_silgen_name("fotufilm_halide_metal_halation_fields_floats")
private func fotufilm_halide_metal_halation_fields_floats(
    _ width: Int32, _ height: Int32, _ radii: UnsafePointer<Int32>?
) -> Int32
@_silgen_name("fotufilm_halide_metal_halation_fields")
private func fotufilm_halide_metal_halation_fields(
    _ light: UnsafePointer<Float>?, _ width: Int32, _ height: Int32,
    _ radii: UnsafePointer<Int32>?, _ fields: UnsafeMutablePointer<Float>?,
    _ fieldsFloats: Int32
) -> Int32
@_silgen_name("fotufilm_halide_metal_process_linear_float_fields_rows")
private func fotufilm_halide_metal_process_linear_float_fields_rows(
    _ input: UnsafePointer<Float>?, _ output: UnsafeMutablePointer<Float>?,
    _ width: Int32, _ height: Int32, _ outY: Int32, _ outRows: Int32,
    _ originX: Int32, _ originY: Int32,
    _ configuration: UnsafePointer<Float>?,
    _ fields: UnsafePointer<Float>?, _ fieldsFloats: Int32, _ fieldsID: UInt64,
    _ exposure: UnsafePointer<Float>?,
    _ film: UnsafePointer<Float>?, _ paper: UnsafePointer<Float>?,
    _ dimension: Int32, _ cacheID: UInt64, _ featureMask: Int32, _ seed: UInt32
) -> Int32
#endif
